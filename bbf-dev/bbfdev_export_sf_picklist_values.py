...
# ---------------------------------------------------------------------
sf_username = "vlettau@everstream.net.bbdev"
sf_password = "MNlkpo0987)(*&"
sf_token = "FSmZPzCYLr15WQQRjDbbEXgGd"
...
for obj_name, df in dataframes.items():
    filename = os.path.join(args.output_dir, f"bbfdev_{obj_name}_picklist_values.csv")
